...
<nav class="navbar navbar-expand-md navbar-light bg-custom">
    <div class="container">
        <Link to="/"><a id="1" class="navbar-brand" href="index.php" onclick="activeLink()" aria-current="page"><img src='../Static/images/logo_harpie.png' alt="logo harpie" width="55px" /></a></Link>
